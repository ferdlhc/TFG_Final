#---------------------------------------------------------#
#---------- Comparador Sistema Fijo Sudafrica ------------#
#---------------------------------------------------------#
...
#os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Pitch/Sudafrica_Horizontal')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Pitch/Sudafrica_Horizontal_2')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="Sudafrica_Horizontal_2"
...
for timess in range (starttimeindex, endtimeindex+1):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_Sudafrica_Horizontal_2_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Pitch/Resultados_Irradiancia/Sudafrica_Horizontal_2.xlsx') as writer:
