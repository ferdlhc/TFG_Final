...
#os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/China_Optimo')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/China_Optimo')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="China_Optimo"
...
starttime_loop = pd.to_datetime('2021-03-21 9:0:0 +8')
endtime_loop =pd.to_datetime('2021-03-21 20:0:0 +8')
...
#epwfile = 'EPWs\\CHN_Tibet.Pagri.557730_SWERA.epw'
...
for timess in range (starttimeindex, endtimeindex+1):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_China_Optimo_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Resultados_Irradiancia/China_Optimo.xlsx') as writer:
