#---------------------------------------------------------#
#------------ Comparador Sistema Fijo Arizona -------------#
#---------------------------------------------------------#
...
#os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Arizona_Horizontal')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Arizona_Horizontal')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="Arizona_Horizontal"
...
starttime_loop = pd.to_datetime('2021-03-20 7:0:0 -7')
endtime_loop =pd.to_datetime('2021-03-20 19:0:0 -7')
...
nRows = 3                   # 3 rows
azimuth_ang = 180            # Facing east (for N-S tracking)
...
#epwfile = 'EPWs\\USA_AZ_Grand.Canyon.National.Park.AP.723783_TMY3.epw'
...
for timess in range (starttimeindex, endtimeindex+1):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_Arizona_Horizontal_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Resultados_Irradiancia/Arizona_Horizontal.xlsx') as writer:
