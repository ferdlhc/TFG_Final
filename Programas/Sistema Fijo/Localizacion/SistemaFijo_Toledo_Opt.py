#---------------------------------------------------------#
#------------ Comparador Sistema Fijo Toledo -------------#
#---------------------------------------------------------#
...
os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Toledo_Optimo')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Toledo_Optimo')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="Toledo_Optimo"
...
starttime_loop = pd.to_datetime('2021-03-20 8:0:0 +1')
endtime_loop =pd.to_datetime('2021-03-20 20:0:0 +1')
...
#epwfile = 'EPWs\\ESP_Toledo.082720_SWEC.epw'
...
for timess in range (starttimeindex, endtimeindex):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_Toledo_Optimo_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Resultados_Irradiancia/Toledo_Optimo.xlsx') as writer:
