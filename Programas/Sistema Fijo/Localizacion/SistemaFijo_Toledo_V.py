...
os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Toledo_Vertical_21')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Toledo_Vertical_21')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="Toledo_Vertical_21"
...
starttime_loop = pd.to_datetime('2021-03-21 8:0:0 +1')
endtime_loop =pd.to_datetime('2021-03-21 20:0:0 +1')
...
for timess in range (starttimeindex, endtimeindex):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_Toledo_Vertical_21_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Resultados_Irradiancia/Toledo_Vertical_21.xlsx') as writer:
