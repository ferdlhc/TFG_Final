...
#os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Toledo_Horizontal')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Toledo_Horizontal')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="Toledo_Horizontal"
...
for timess in range (starttimeindex, endtimeindex):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_Toledo_Horizontal_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Resultados_Irradiancia/Toledo_Horizontal.xlsx') as writer:
