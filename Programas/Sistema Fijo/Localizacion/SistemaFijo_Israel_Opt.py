#---------------------------------------------------------#
#------------ Comparador Sistema Fijo Israel -------------#
#---------------------------------------------------------#
...
os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Israel_Optimo')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Israel_Optimo')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="Israel_Optimo"
...
#epwfile = 'EPWs\\ISR_Eilat.401990_MSI.epw'
...
for timess in range (starttimeindex, endtimeindex+1):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_Israel_Optimo_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Resultados_Irradiancia/Israel_Optimo.xlsx') as writer:
