...
#os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Arizona_Optimo')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Arizona_Optimo')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="Arizona_Optimo"
...
#epwfile = 'EPWs\\USA_UT_Blanding.Muni.AP.724723_TMY3.epw'
...
for timess in range (starttimeindex, endtimeindex+1):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_Arizona_Optimo_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Resultados_Irradiancia/Arizona_Optimo.xlsx') as writer:
