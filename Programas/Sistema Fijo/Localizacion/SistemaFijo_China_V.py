...
#os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/China_Vertical')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/China_Vertical')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="China_Vertical"
...
for timess in range (starttimeindex, endtimeindex+1):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_China_Vertical_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Sistemas_Fijos/Localizacion/Resultados_Irradiancia/China_Vertical.xlsx') as writer:
