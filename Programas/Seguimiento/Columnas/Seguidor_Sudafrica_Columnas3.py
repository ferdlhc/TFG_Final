...
os.mkdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Seguimiento/Columnas/Sudafrica_Columnas3')
os.chdir('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Seguimiento/Columnas/Sudafrica_Columnas3')
path = os.getcwd()
print("Cambio de directorio de trabajo a:", path)

simulationName="Sudafrica_Columnas3"
...
for timess in range (starttimeindex, endtimeindex+1):
    ...
    results_df.append(bifacial_radiance.load.read1Result(f'results/irr_Sudafrica_Columnas3_{j}.csv'))
...
with pd.ExcelWriter('C:/Users/ferdl/Documents/bifacial_radiance/TFG_Final/Seguimiento/Columnas/Resultados_Irradiancia/Sudafrica_Columnas3.xlsx') as writer:
